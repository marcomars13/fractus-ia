...
OUT_JSON = "results/local_test_extended_report.json"

# Échantillon d’images locales connues (adapter aux noms présents dans ta base Mapillary)
IMAGES_TO_TEST = [
    "1516881052808566.jpg",   # Aubagne
    "1982165845268582.jpg",   # Ste-Baume
    "1983632975125869.jpg",   # Cappadoce
    "9914416162010971.jpg",   # Marseille
    "4252088971509081.jpg",   # Autre Aubagne centre
    "2107742459396991.jpg",   # Ste-Baume autre angle
]
...
def main():
    ...
    print("=== LOCAL TEST REPORT (étendu) ===")
    for r in results:
