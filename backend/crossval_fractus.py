...
OUTPUT_CSV = "/Users/marco/Projets/fractus-ia/results/bench_crossval_fractus.csv"
...
def main():
    ...
    for test_shard in shard_files:
        print(f"🚀 Cross-val : test sur {os.path.basename(test_shard)}")
        ...
        # Construire index (euclidean sur vecteurs normalisés = cosine)
